...
import none.lwjgl.scenes.ui.UiScene;
...
public class UiApp {
    ...
    public static void main(String[] args) {
        ...
        UiScene uiScene = new UiScene(factory, game);

        List<Scene> sceneList = new ArrayList<>();
        sceneList.add(uiScene);

        SceneManager manager = new SceneManager(game, sceneList, UiScene.NAME);
